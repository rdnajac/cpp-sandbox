...
int main() {
    ...
    std::cout << "Maximum value of int8_t: " << static_cast<int>(std::numeric_limits<int8_t>::max()) << std::endl;
    std::cout << "Minimum value of int8_t: " << static_cast<int>(std::numeric_limits<int8_t>::min()) << std::endl;
    std::cout << "Maximum value of uint8_t: " << static_cast<int>(std::numeric_limits<uint8_t>::max()) << std::endl;
    ...
    // Memory operations
    std::cout << "Memory address of signed_8bit: " << static_cast<void*>(&signed_8bit) << std::endl;
    std::cout << "Value at generic_pointer: " << static_cast<int>(*static_cast<int8_t*>(generic_pointer)) << std::endl;
