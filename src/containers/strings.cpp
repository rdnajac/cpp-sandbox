 ...
 * 
 * @param data A string containing sea creature data in the format "name,appendages;name,appendages;..."
 */
void processSeaCreatures(const std::string& data) {
    ...
    for (const auto& creature : creatures) {
        std::cout << "Creature: " << creature.name << ", Appendages: " << creature.appendages << std::endl;
    }
}
...
/**
 * @brief Transforms each word in the input string by applying transform_to_opposite to each character
 * 
